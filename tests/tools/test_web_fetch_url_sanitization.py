...
from secbot.agent.tools.web import WebFetchTool, _validate_url
...
def _patch_env():
    return patch("secbot.security.network.socket.getaddrinfo", _fake_resolve_public), \
           patch("secbot.agent.tools.web.httpx.AsyncClient", FakeClient)
