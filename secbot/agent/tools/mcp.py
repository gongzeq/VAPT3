"""MCP client: connects to MCP servers and wraps their tools as native secbot tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a secbot Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only secbot Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only secbot Tool."""
