...
from secbot.utils.helpers import build_image_content_blocks

if TYPE_CHECKING:
    from secbot.config.schema import WebFetchConfig, WebSearchConfig
        ...
        try:
            async with httpx.AsyncClient(proxy=self.proxy, follow_redirects=True, max_redirects=MAX_REDIRECTS, timeout=15.0) as client:
                async with client.stream("GET", url, headers={"User-Agent": self.user_agent}) as r:
                    from secbot.security.network import validate_resolved_url
