...
from secbot.agent.tools.sandbox import wrap_command
...
class ExecTool(Tool):
    ...
    def __init__(
        ...
        self.deny_patterns = (deny_patterns or []) + [
            ...
            r":\(\)\s*\{.*\};\s*:",          # fork bomb
            # Block writes to secbot internal state files (#2989).
    ...
    async def execute(
        ...
        if self.path_append:
            if _IS_WINDOWS:
                ...
                env["SECBOT_PATH_APPEND"] = self.path_append
                command = f'export PATH="$PATH{os.pathsep}$SECBOT_PATH_APPEND"; {command}'
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        ...
        from secbot.security.network import contains_internal_url
