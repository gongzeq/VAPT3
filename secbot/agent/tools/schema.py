"""JSON Schema fragment types: all subclass :class:`~secbot.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~secbot.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~secbot.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~secbot.agent.tools.base.Schema`.
...
from secbot.agent.tools.base import Schema
