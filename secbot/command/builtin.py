...
from secbot import __version__
from secbot.bus.events import OutboundMessage
from secbot.command.router import CommandContext, CommandRouter
from secbot.utils.helpers import build_status_content
from secbot.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "secbot"] + sys.argv[1:])
...
async def cmd_status(ctx: CommandContext) -> OutboundMessage:
    ...
    with suppress(Exception):
        from secbot.utils.searchusage import fetch_search_usage
