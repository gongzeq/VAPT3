...
This directory contains built-in skills that extend secbot's capabilities.
...
When skills reference large local documentation or logs, prefer secbot's built-in
