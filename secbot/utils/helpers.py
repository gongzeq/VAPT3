...
_TOOL_RESULTS_DIR = ".secbot/tool-results"
...
def sync_workspace_templates(workspace: Path, silent: bool = False) -> list[str]:
    ...
    try:
        tpl = pkg_files("secbot") / "templates"
    except Exception:
        return []
    if not tpl.is_dir():
        return []
    ...
    try:
        from secbot.utils.gitstore import GitStore
