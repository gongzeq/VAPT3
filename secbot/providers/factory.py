...
from secbot.providers.base import GenerationSettings, LLMProvider
...
def make_provider(config: Config) -> LLMProvider:
    ...
    if backend == "openai_codex":
        ...
        from secbot.providers.azure_openai_provider import AzureOpenAIProvider
        ...
        from secbot.providers.anthropic_provider import AnthropicProvider
...
def load_provider_snapshot(config_path: Path | None = None) -> ProviderSnapshot:
    from secbot.config.loader import load_config, resolve_config_env_vars
