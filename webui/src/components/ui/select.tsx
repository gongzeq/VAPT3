...
/**
 * shadcn/ui (new-york) Select. Token-driven dropdown replacing the native
 * ``<select>`` elements in settings/workflow forms so the trigger, popover and
 * items share the app's radius, border and focus-ring contract.
 */
