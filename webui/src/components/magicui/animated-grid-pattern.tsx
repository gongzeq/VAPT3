// Source: https://magicui.design/r/animated-grid-pattern.json — copied 2026-05-07
...
//   - Default fill/stroke `gray-400/30` retained from upstream — they are
//     intentionally neutral (this component sits as a subtle background
//     pattern). Override the color via `className="fill-foreground/10"` etc.
//     at the call site if a brand-tinted variant is needed.
"use client";
